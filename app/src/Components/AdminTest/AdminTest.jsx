...
import style from './AdminTest.module.css'
import {Button, ButtonGroup, Paper, Typography} from "@material-ui/core";
import {quizChoiceThunk, showResults} from "../Redux/admin-test-reducer";
import {NavLink} from "react-router-dom";

const AdminTest = () => {
    const quizSelector = useSelector(state => state.adminTest.quiz);
